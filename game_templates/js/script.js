    $(document).ready(function () {
        ...
        for (i = 0; i < amountBauern; i++) {
            $('.bauernKarte').append('<img class="bauer" src="game_templates/img/farmer.png">');
        }
        ...
        for (i = 0; i < countFabrik; i++) {
            $('.fabrikKarte').append('<img class="fabrik" src="game_templates/img/factory.png">');
        }
        ...
        if (amountBauern >= 3 && clickercount > 1000 && amountReload > 3) {
            $(".bauernKarte").empty();
            for (i = 0; i < amountBauern; i++) {
                $('.bauernKarte').append('<img class="bauer cat" src="game_templates/img/nekogirl.png">');
            }
            $('.clicker').attr('onclick', 'playAudio("game_templates/audio/nyan.mp3")');
        } else {
        ...
        $('.bauerUpgradeWrapper .upgradeNode').click(function () {
            if (clickercount >= upgradeBauerCost) { // wen man genug clickers besitzt
                ...
                $('.bauernKarte').append('<img class="bauer" src="game_templates/img/farmer.png">'); // bauer erstellen in der Karte
        ...
        $('.fabrikUpgradeWrapper .upgradeNode').click(function () {
            if (clickercount >= upgradeFabrikCost) { // wen man genug clickers besitzt
                ...
                $('.fabrikKarte').append('<img class="fabrik" src="game_templates/img/factory.png">') // Fabrik erstellen in der Karte
            } else { // wen man zu wenig clickers
        ...
        $('.portalUpgradeWrapper .upgradeNode').click(function () {
            if (clickercount >= upgradePortalCost) { // wen man genug clickers besitzt
                ...
                $('.portalKarte').append('<img class="portal" src="game_templates/img/portal.png">') // Portal erstellen in der Karte
            } else { // wen man zu wenig clickers
